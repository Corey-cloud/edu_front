  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      ...
      <section class="path-wrap txtOf hLh30">
            ...
            \
            <a :href="/subject/+course.subjectLevelOneId" title class="c-999 fsize14">{{ course.subjectLevelOne }}</a>
            \
                                    ...
                                    <li v-for="chapter in chapterList" :key="chapter.id" class="lh-menu-stair">
                                        ...
                                        <ol class="lh-menu-ol" style="display: block;">
                                            <li v-for="video in chapter.children" :key="video.id" class="lh-menu-second ml30">
                                                <a :href="/video/+video.videoSourceId" title>
...
export default {
    asyncData({params, error}){
        //调用后台的接口
        return courseApi.getCourseInfoWebByCourseId(params.id).then(response => {
            return {
                course: response.data.data.dataList,
